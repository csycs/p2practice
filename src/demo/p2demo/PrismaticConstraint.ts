class PrismaticConstraint extends BaseClass {
    ...
    private _prismaticConstraint: p2.PrismaticConstraint;
    private createConstraint() {
        this._prismaticConstraint = new p2.PrismaticConstraint(
            this._boxBody1,
            this._boxBody2,
            { maxForce: 10 });
        this._world.addConstraint(this._prismaticConstraint);
    }
